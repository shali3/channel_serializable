...
abstract class HelperCore {
  ...
  final ChannelSerializable config;
  ...
  @protected
  ChannelKey channelKeyFor(FieldElement field) =>
      channelKeyForField(field, config);

  @protected
  TypeHelperCtx getHelperContext(FieldElement field) =>
      typeHelperContext(this, field, channelKeyFor(field));
}
