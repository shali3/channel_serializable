...
const _configReplacements = {
  'any_map': _Replacement.addChannelSerializableKey('anyMap', true),
  'checked': _Replacement.addChannelSerializableKey('checked', true),
  'non_nullable': _Replacement.addChannelSerializableKey('nullable', false),
  'explicit_to_json':
      _Replacement.addChannelSerializableKey('explicitToJson', true),
  'exclude_null':
      _Replacement.addChannelSerializableKey('includeIfNull', false),
};
...
class _Replacement {
  ...
  const _Replacement.addChannelSerializableKey(String key, bool value)
      : existing = '@ChannelSerializable(',
        replacement = '@ChannelSerializable(\n  $key: $value,';
